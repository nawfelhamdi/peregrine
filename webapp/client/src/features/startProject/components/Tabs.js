...
function Tabs(props) {
  return (
    <div className="bg-white shadow-none lg:shadow-md px-4 md:px-16 w-full relative lg:fixed mt-16 border-t border-white py-4 z-0 lg:z-20">
          ...
          <div className="flex items-center space-x-1 lg:space-x-8">
            ...
            >
              <button className="flex flex-col lg:flex-row py-2 items-center h-14 lg:h-12  px-3 text-sm font-medium lg:font-bold tracking-wide transition duration-200 rounded-md shadow-md">
                ...
                <span className="hidden md:block mr-1">Results and </span>{' '}
                Reports
              </button>
            </NavLink>
          </div>
