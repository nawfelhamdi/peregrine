...
exports.getArchiveFiles = void 0;
const path_1 = __importDefault(require("path"));
require("dotenv").config({ path: path_1.default.join(__dirname, "..", "..", "..", ".env") });
const { BlobServiceClient } = require('@azure/storage-blob');
const CustomError_1 = require("../../utils/CustomError");
const getArchiveFiles = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var e_1, _a;
    try {
        ...
        const customError = new CustomError_1.CustomError("Can't list archive files", 500, err);
